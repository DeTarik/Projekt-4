...
public class AList {
    ...
    public static void removeBok () {
        System.out.println("Skriv in namnet på boken som skall tas bort:");
        String name = scanner.nextLine();
        removeBok(name,biblotek);

    }

    public static void removeBok(String name, Biblotek biblotek){    // Gör mocking en som lyckas och ett som misslyckas
